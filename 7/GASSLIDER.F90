	...
	DATA N,U,X1,X2,H1,H2,EDA,AL/121,1.0,0.0,1.0,1.0,0.5,1.79E-5,0.01/
...
40	FORMAT(1X,4(E12.6,1X))
	...
	COMMON /COM1/X1,X2,H1,H2,U,EDA,AL,ALOAD,DX
	DATA PA/1.013E5/
	ALENDA=6.0*EDA*U*AL/PA/(H2*1.0E-6)**2
	DO I=2,N-1
	P(I)=0.5
	ENDDO
	P(1)=1.0
...
10	C1=0.0
	...
	A2=(0.5*(H(I)+H(I-1)))**3
	PD=P(I)
	P(I)=(-DX*ALENDA*(P(I+1)*H(I+1)-P(I-1)*H(I-1))+A1*P(I+1)**2+A2*P(I-1)**2)/(A1+A2)
